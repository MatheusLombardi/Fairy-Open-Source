...
module.exports.run = async (client, message, args) =>{//Sim, ele tá na base da Loritta.
  ...
  let emoticon;
    if(amor > 60) {
      ...
      emoticon = ("https://cdn.glitch.com/00963c7e-8e86-4a55-8d85-36add9e330d7%2Femoji_3-1.png?v=1593652255529"); //Imagem aleatória
    } else {
